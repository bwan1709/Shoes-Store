			...
			<section class="mb-5">
				<div class="row">
							...
							<div class="row product-gallery mx-1">
								<div class="col-12 mb-0">
									<figure class="view overlay rounded z-depth-1 main-img"
										...
										<a href="${detail.image}" data-size="710x823"> <img
											src="${detail.image}" class="img-fluid z-depth-1"
					...
					<div class="col-md-6">
						<h5>${detail.name}</h5>
						<p>
							<span class="mr-1"><strong>$${String.format("%.02f",
									detail.price * 0.9)}</strong></span><span class="text-grey"><strong><s>$${detail.price}</s></strong></span>
						</p>
						...
						<form action="/addCart" method="post">
							...
							<!-- Các input và nút khác -->
							<div class="table-responsive mb-2">
								<table class="table table-sm table-borderless">
									<tbody>
										<tr>
											<td class="pl-0 pb-0 w-25">Số lượng</td>
											<td class="pb-0">Chọn kích thước</td>
										</tr>
										<tr>
											<td class="pl-0">
												<div class="mt-1">
