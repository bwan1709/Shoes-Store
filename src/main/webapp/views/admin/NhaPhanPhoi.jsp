								...
								<tbody>
									<c:forEach items="${listAllSupplier}" var="o">
										<tr>
											...
											<td><c:forEach items="${listAllCategory}" var="t">
													<c:if test="${o.category.cid==t.cid}">
                                            ${t.cname}
                                        </c:if>
												</c:forEach></td>
											<td><a href="deleteSupplier?id=${o.idSupplier}"
			...
			<div class="modal-content">
				<form action="/admin/addSupplier" method="post">
					...
					<div class="modal-body">
						...
						<div class="form-group">
							<label>Cung cấp cho</label> <select name="category.cid"
